...
| 子域名枚举（v1.3.0+） | 6 被动源(crt.sh + CertSpotter + HackerTarget + OTX + Wayback v1.4.9)+ **可选 subfinder 30+ 源(v1.4.8)** + **DNS 字典爆破 v1.4.9(220 词,可自定义)** + **JS/HTML body host 提取 v1.4.9(默认开)** + DNS A/AAAA/CNAME + HTTP probe | 是 |
